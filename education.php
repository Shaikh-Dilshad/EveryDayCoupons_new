...
<body>
    ...
    <section>
            <div class="ecommercesection">
                <h1>
                    Education Templates area
                </h1>
                <p>Choose Education website and we build as per your guidenes how you and how want to see you website
                </p>
            </div>
        </section>
        ...
        <section class="section3">
            ...
            <div class="content">
                ...
                <div class="content1 f1">
                    <form action="manage_foreducation.php" class='clickerchange' method="POST">
                        <div class="subf1">
                            <div class="imgg">
